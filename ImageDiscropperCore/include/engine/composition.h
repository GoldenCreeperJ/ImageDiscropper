...
//   - isCollapsible：§5.4 坍缩可行性定理的判定接口，属于待实现算法，仅声明。
// 说明：接口骨架，只描述“怎么摆、怎么导”，不实现像素拼接。
// ============================================================================
#pragma once
...
// ---------------------------------------------------------------------------
enum class EmitMode {
    SEPARATE,  // 多图分离：每个保留单元一张图，可打包 zip（§5.1 / FR-L3.6）
...
// 声明占位，桩实现见 src/engine/composition.cpp，真正实现留待 MVP 阶段。
