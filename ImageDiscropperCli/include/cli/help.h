// ============================================================================
// 文件：include/cli/help.h
// 作用：集中生成帮助与版本文本（guideline §6）。帮助文本是 CLI 的「自解释入口」，
//       术语须与终稿 §3.2 一致（切割线 / 带 / 单元 / 十字带 / 极性 / 坍缩 / 重排）。
...
// 顶层帮助：工具定位 + 三层模式（L1/L2/L3）+ 子命令清单 + 全局选项 + 各层示例（§6.1）。
void printTopHelp();
...
// 子命令帮助：命令语义（对应哪一层 / 模式）+ 全部选项（含义 / 默认 / 必填）+ 示例 + 常见错误（§6.1）。
