// ============================================================================
// 文件：include/cli_error.h
// 作用：定义 CLI 的错误载体 CliError 与统一的错误输出 reportError（错误格式见 Cli README）。
//       把「退出码 + 简短描述 + 详情 + 提示」打包为一处，确保所有错误以同一格式写 stderr，
//       stdout 只留正常结果与进度（CONTRIBUTING.md「分层纪律」）。
...
// 按 Cli README「错误格式」把错误写到 stderr：
//   idc: error: <brief>
