...
//       也避免把所有测试塞进单一 God File（guideline：严禁上帝文件）。
...
//   testEnginePipeline —— §3.1 功能：L1/L2 保留尺寸与四角位置、极性开关、L3 网格/选择/排序/重排。
//   testEngineExport   —— §5 导出：分离到文件夹、坍缩合并、降级重排、PNG/BMP/JPEG/WebP 四格式写盘。
//   testEngineBoundary —— §6 边界：E-1~E-8 全覆盖 + 空块跳过 + 像素无重复无丢失。
// ---------------------------------------------------------------------------
